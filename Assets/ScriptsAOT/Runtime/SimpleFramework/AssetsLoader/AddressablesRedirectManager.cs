...
public static class AddressablesRedirectManager
{
    ...
    public static IEnumerator Do()
    {
        if (_bundleCacheList == null)
        {
            ...
            var url = GameConst.getStreamingAssetsPathUrl(bundleCacheFilePath);
    ...
    {
        return GameConst.StreamingAsset_CacheBundleDir + GameConst.StreamingAsset_CacheBundleJsonFileName;
    }
